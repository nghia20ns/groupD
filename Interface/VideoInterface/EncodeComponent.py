...
class EncodeComponent(tk.Frame):
    def __init__(self, master):
        ...
        # File Path Entry
        lbl_file = tk.Label(self, text="File Encode:", bg="white", font=("Arial", 10))
        ...
        # New File Name Entry
        lbl_image = tk.Label(self, text="Name New File:", bg="white", font=("Arial", 10))
        lbl_image.grid(row=7, column=0, padx=10, pady=10, sticky="e")
        self.new_video = ttk.Entry(self, width=30, font=("Arial", 10))
