...
class DecodeComponent(tk.Frame):
    def __init__(self, master):
        ...
        lbl_text.grid(row=5, column=0, padx=10, pady=10, sticky="e")
        # Frame cho các nút RadioButton
        self.buttons_frame = tkinter.Frame(self, bg="white")
        self.buttons_frame.grid(row=5, column=1, pady=10)
        ...
        lbl_txt.grid(row=7, column=0, padx=10, pady=10, sticky="e")
        self.new_txt = ttk.Entry(self, width=30, font=("Arial", 12))
        self.new_txt.grid(row=7, column=1, pady=10, sticky="we")
